...
public static class SuperSunNutPatch
{
    ...
    public static unsafe bool PreTakeDamage(SuperSunNut __instance)
    {
        if (__instance.thePlantType is (PlantType)161)
        {
            ...
            var ptr = stackalloc IntPtr[2];
            *ptr = (nint)(&damage);
            var i = 0;
            *(int**)((byte*)ptr + checked(1u * unchecked((nuint)sizeof(IntPtr)))) = &i;
            Unsafe.SkipInit(out IntPtr exc);
            IL2CPP.il2cpp_runtime_invoke(
                (IntPtr)typeof(Plant).GetField("NativeMethodInfoPtr_TakeDamage_Public_Virtual_New_Void_Int32_Int32_0",
                    BindingFlags.NonPublic | BindingFlags.Static)!.GetValue(null)!,
                IL2CPP.Il2CppObjectBaseToPtrNotNull(__instance), (void**)ptr, ref exc);
...
public class Core : BasePlugin
{
    public override void Load()
    {
        ...
        CustomCore.RegisterCustomPlant<SuperSunNut, SuperDiamondNut>(161,
            ab.GetAsset<GameObject>("SuperDiamondNutPrefab"),
        ...
        CustomCore.AddPlantAlmanacStrings(161, "钻石帝果(161)",
        ...
        CustomCore.AddPlantAlmanacStrings(162, "钻石保龄球(162)",
...
{
    public SuperDiamondNut() : base(ClassInjector.DerivedConstructorPointer<SuperDiamondNut>())
    {
    ...
    public void Awake()
    {
        if (GameAPP.theGameStatus is (int)GameStatus.InGame && !Board.Instance.isIZ && !Board.Instance.isEveStart &&
            gameObject.GetComponent<SuperSunNut>().thePlantType is (PlantType)161)
    ...
    public static void SummonAndRecover(Plant plant)
    {
        ...
        if (plant.board.theMoney >= 3000 && ssn is not null)
        {
            ...
            var newPlantObj = CreatePlant.Instance.SetPlant(
            ...
            if (newPlantObj != null)
            {
                ...
                {
                    var position = ssn.targetPlant.axis.position;
